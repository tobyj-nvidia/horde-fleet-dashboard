...
_MOCK_QUERY_MAP: dict[str, tuple[list[dict], dict | None]] = {
    ...
    'select * from task_results where task_id': ([], {
        ...
        'outcome': 'success',
        'summary': '{"per_repo_push_summary": {"acme/core": {"publication_mode": "pull_request", "publication_source": "repo_config", "pr_url": "https://github.com/acme/core/pull/42", "pr_number": 42, "pr_branch": "fleet/task-mock-001", "publication_outcome": "pr_created"}}}',
        'error_msg': None,
        ...
        'pr_number': 42,
        'pr_branch': 'fleet/task-mock-001',
        'publication_outcome': 'pr_created',
    }),
    'left join task_results tr on tr.task_id = coalesce(t.task_id, t.id)': ([{
        'id': 'task-mock-001',
        'type': 'code-gen',
        'name': 'mock-task',
        'project': 'acme',
        ...
        'pr_branch': 'fleet/task-mock-001',
        'publication_outcome': 'pr_created',
        'result_summary': '{"per_repo_push_summary": {"acme/core": {"publication_mode": "pull_request", "publication_source": "repo_config", "pr_url": "https://github.com/acme/core/pull/42", "pr_number": 42, "pr_branch": "fleet/task-mock-001", "publication_outcome": "pr_created"}}}',
    }], None),
    'select * from tasks where task_id': ([], None),
    'select * from tasks': ([{
        'id': 'task-mock-001',
        'type': 'code-gen',
        'name': 'mock-task',
    ...
    return [
        {
            ...
            "pr_url": "https://github.com/acme/core/pull/42",
            "pr_number": 42,
            "pr_branch": "fleet/task-done-0003",
            "publication_repos": [
                {
                    "repo_slug": "acme/core",
                    "publication_mode": "pull_request",
